...
model = xgb.XGBClassifier(objective="multi:softmax", num_class=3, seed=42, n_estimators=100, max_depth=2, eta=0.1, subsample=0.5, colsample_bytree=0.3, \
...
# Test F1 Score : [0.94736842 0.66666667 0.8]
# Test weighted F1 Score : 0.827
...
for subject in subjects:
    ...
    y = y.values
    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.30)
    model = model = xgb.XGBClassifier(objective="multi:softmax", num_class=3, seed=42, n_estimators=100, max_depth=2, eta=0.1, subsample=0.5, colsample_bytree=0.3, \
