# Generate CSV PSD's for Healthy Controls and Schizophrenia at Task dataset, split by healthy and schizophrenia
...
dataset.to_csv("Dataset_Schizophrenia_Task_S.csv", index = False)
...
dataset = normalize(dataset)
dataset.to_csv("Dataset_Schizophrenia_Task_H.csv", index = False)
