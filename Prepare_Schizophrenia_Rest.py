# Generate CSV PSD's for Healthy Controls and Schizophrenia at Rest dataset
...
if os.path.exists("Dataset_Schizophrenia_Rest.csv"):
    dataset = pd.read_csv("Dataset_Schizophrenia_Rest.csv")
else:
    ##################################################################################################################################################################
    ...
    dataset.to_csv("Dataset_Schizophrenia_Rest.csv", index = False)